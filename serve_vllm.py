...
def main():
    ...
    parser.add_argument(
        ...
        help='Enable a reasoning parser to separate <think> tokens from the main '
             'response content. Use "qwen3" for Qwen3 models so that thinking '
             'output does not bleed into the visible message content.'
    )
